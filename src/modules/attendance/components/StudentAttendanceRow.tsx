  ...
  return (
    <button
      ...
      className={joinClasses(
        'w-full flex flex-col min-[420px]:flex-row gap-3 min-[420px]:items-center min-[420px]:justify-between p-3 sm:p-4 rounded-xl border-2 transition-all min-h-[56px] text-start',
        isPresent
