...
export default async function AdminSettingsPage() {
  ...
  return (
    <div className="space-y-8" dir="rtl">
      ...
      <div className="rounded-2xl border border-sky-300/20 bg-slate-900/50 p-6 backdrop-blur">
        ...
        <form action={saveContact} className="flex flex-col gap-4 sm:flex-row sm:items-end">
          ...
          <button
            type="submit"
            className="rounded-xl bg-sky-500 px-6 py-2.5 text-sm font-bold text-white transition hover:bg-sky-400 active:scale-95"
          >
            حفظ
          </button>
        </form>
