...
export default async function UnifiedLoginPage({
  ...
  return (
    ...
    >
      <Link
        href="/"
        className="absolute end-4 top-4 inline-flex items-center gap-1 rounded-lg border border-slate-200 bg-white/40 dark:border-white/10 dark:bg-white/5 px-4 py-2 text-sm font-semibold text-slate-600 dark:text-[#94A3B8] backdrop-blur transition hover:bg-white/60 dark:hover:bg-white/10 sm:end-6 sm:top-6 shadow-sm"
      >
